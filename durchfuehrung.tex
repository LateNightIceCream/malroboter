...
Falls ihr nicht weiterwisst, gibt es \href{https://tuduu.org/projekt/automatischer-malroboter}{hier}\footnote[2]{https://tuduu.org/projekt/automatischer-malroboter} auch nochmal die ausführlichere Beschreibung.\\
...
Sobald alles verkabelt ist, können auch die Motoren auf den Pappkarton oder das Buch (also eure Unterlage) geklebt werden.
Jetzt geht's weiter mit dem technischen Teil.\\
}
...
\end{tabular}
\end{center}
\caption{Verbindungen zwischen dem Treiber und den Motoren. Die Polarität der Motoren spielt dabei keine Rolle, ihr müsst euch also keinen Kopf darum machen, welches Kabel nach links oder rechts muss.}
\end{table}
...
Achtet besonders auf die letzte Verbindung in der Tabelle! Am besten verbindet ihr hier mit einem Male-Female Jumperkabel, wie ihr es im Bild oben sehen könnt (das schwarze dünne Kabel neben dem dicken weißen).\\
